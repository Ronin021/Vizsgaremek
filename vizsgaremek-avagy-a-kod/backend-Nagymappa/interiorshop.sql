-- ============================================================
-- InteriorShop adatbázis - XAMPP / MariaDB / MySQL kompatibilis
-- ============================================================
-- Importálás előtt: hozd létre az 'interiorshop' adatbázist a phpMyAdmin-ban,
-- vagy futtasd:  CREATE DATABASE IF NOT EXISTS interiorshop;
--                USE interiorshop;
-- ============================================================

-- Táblák törlése (fordított sorrend a FOREIGN KEY-k miatt)
...
-- Seed felhasználók (plaintext jelszavak):
--   janos@example.com / janos123
--   anna@example.com  / anna123
--   peter@example.com / peter123
--   admin@example.com / admin123  (admin jogosultság)
